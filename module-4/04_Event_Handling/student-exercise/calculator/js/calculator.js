...
document.addEventListener('DOMContentLoaded', () => {
  ...
  calculator.keys.numbers.forEach(key => {
  ...
  calculator.keys.decimal.addEventListener("click", clickNumber);

  // get a reference to the all clear button
  // add a click event listener to call the function clear  
  calculator.keys.allClear.addEventListener("click", clear);
  ...
  calculator.keys.operators.forEach(key => {
  ...
  calculator.keys.equalSign.addEventListener("click", performOperation);
