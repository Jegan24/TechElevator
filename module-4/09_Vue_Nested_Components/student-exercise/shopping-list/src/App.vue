<template>
  <div id="app">
    ...
    <shopping-list title="Groceries" v-bind:items="groceries" v-bind:search="search"></shopping-list>
    <shopping-list title="Costco" v-bind:items="costco" v-bind:search="search"></shopping-list>
    <shopping-list title="Target" v-bind:items="target" v-bind:search="search"></shopping-list>
  </div>
</template>
